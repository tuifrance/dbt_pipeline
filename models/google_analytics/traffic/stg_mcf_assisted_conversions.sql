...
select
    ...
    case
        ...
        then 'SEA Generic'
        when medium = 'organic' or medium = 'qwant.com' or medium like '%yahoo.com%'
        then 'SEO'
        ...
        when
            ...
            and source != 'EPERFLEX'
        then 'Affiliation'
        when medium = 'retargeting' and source = 'CRITEO' or source = 'EPERFLEX'
        then 'Retargeting Display'
        when source = 'Facebookads' and medium in ('retargeting', 'Retargeting')
        ...
        when source = 'Facebookads' and medium not in ('retargeting', 'Retargeting')
        then 'Paid Social'
        when
            channel_grouping = 'Social' and medium not in ('retargeting', 'Retargeting')
        then 'Social'
        when channel_grouping in ('Accès Direct', 'Référents') and source != 'qwant.com'
        then 'Direct'
        else 'Autre'
