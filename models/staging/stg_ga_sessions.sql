...
with
  ...
  distinct
            ...
            case
                ...
                when
                    trafficsource.source = 'Facebookads' and trafficsource.medium in (
                ...
                when
                    trafficsource.source = 'Facebookads'
                    and trafficsource.medium not in ('retargeting', 'Retargeting')
                then 'Paid Social'
                when
                    channelgrouping = 'Social' and trafficsource.medium not in (
                        'retargeting', 'Retargeting'
                    )
                then 'Social'
                when
                    channelgrouping in (
                        'Accès Direct', 'Référents'
