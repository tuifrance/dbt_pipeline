...
date_range,
Unnest (hits) as h
where _table_suffix between start_date and end_date and h.eventInfo.eventCategory ='Home Pages - Zones de Clic'  and h.eventInfo.eventAction = 'HP-General-header'
